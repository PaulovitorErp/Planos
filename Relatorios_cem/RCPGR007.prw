...
Static Function ReportDef()
	...
	Local oDetalhe
	Local oTotal
	Local cTitle    	:= "Relatório de Comissão por Vendedor (Analítico) - Funerária"
...
//variaveis das perguntas
	...
	oReport:= TReport():New("RCPGR007",cTitle,"RCPGR007",{|oReport| PrintReport(oReport,oComissao,oDetalhe,oTotal)},"Este relatório apresenta a relação de comissões por Vendedor.")
	...
	//TRCell():New(oDetalhe,"E3_XPARCOM"	,"QRYCOMI", "Parc. Comissão", 	PesqPict("SE3","E3_XPARCOM"),TamSX3("E3_XPARCOM")[1]+3)
...
Static Function AjustaSX1()
	...
	U_xPutSX1( cPerg, "07","Considera comissão ?          ","","","mv_ch7","C",1,0,0,"C","","","","",;
	...
	U_xPutSX1( cPerg, "09","Até a Data ?                  ","","","mv_ch9","D",8,0,0,"G","(MV_PAR07 >= MV_PAR06)","","","",;
		"mv_par09","","","","","","","","","","","","","","","","",;
