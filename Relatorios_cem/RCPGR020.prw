...
/*/{Protheus.doc} RCPGR020
Impressão de Relatório Contratos Utilizados por Tipo
Orientação do tipo Paisagem
@author André R. Barrero
@since 20/06/2016
@version P12
/*/
User Function RCPGR020()
	Local oReport
...
Static Function ReportDef()
	...
	Local oTotal
	Local oTotalGer
	Local cTitle    	:= "Relatório Contratos Utilizado por Tipo - Contratos"

	Private cPerg		:= "RCPGR020"

	oReport	:= TReport():New("RCPGR020",cTitle,"RCPGR020",{|oReport| PrintReport(oReport,oContrato,oDetalhe,oTotalGer)},"Este relatório apresenta a relação de Contratos Utilizados por Tipo.")
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	TRCell():New(oDetalhe,"U04_DTUTIL"	,"QRYCONT","DT.UTIL."	,	PesqPict("U04","U04_DTUTIL"	),TamSX3("U04_DTUTIL"	)[1]+3)
	TRCell():New(oDetalhe,"U04_QUEMUT"	,"QRYCONT","UTILIZADO"	,	PesqPict("U04","U04_QUEMUT"	),TamSX3("U04_QUEMUT"	)[1]+1)
...
Static Function PrintReport(oReport,oContrato,oDetalhe,oTotalGer)
	...
	cQry := "SELECT U00.U00_FAQUIS, U00.U00_CODIGO, U00.U00_VALOR, U00.U00_NOMCLI, U00.U00_DATA,U04.U04_DTUTIL,U04.U04_QUEMUT "
	cQry += " FROM "+RetSqlName("U00")+" U00 INNER JOIN "+RetSqlName("U04")+" U04"
	...
	If !Empty(MV_PAR03)
		cQry += " 	AND U00.U00_PLANO	IN " + FormatIn( AllTrim(MV_PAR03),";")"
	Endif
	If ! Empty(MV_PAR04) .And. ! Empty(MV_PAR05)
		cQry += " 	AND U04.U04_DTUTIL 	BETWEEN '"+DtoS(MV_PAR04)+"' AND '"+DtoS(MV_PAR05)+"'"
	EndIf
	cQry += " 	AND U00.U00_CLIENT 	BETWEEN '"+MV_PAR06+"' AND '"+MV_PAR08+"'"
	cQry += " 	AND U00.U00_LOJA 	BETWEEN '"+MV_PAR07+"' AND '"+MV_PAR09+"'"
	If MV_PAR10 = 2
		cQry += " 	AND U00.U00_FAQUIS = 'I' "
	ElseIf MV_PAR10 = 3
		cQry += " 	AND U00.U00_FAQUIS = 'P' "
	EndIf
	cQry += " 	ORDER BY U00.U00_FAQUIS, U04.U04_DTUTIL, U00.U00_CODIGO, U00.U00_VALOR, U00.U00_NOMCLI "
	...
	While !oReport:Cancel() .And. QRYCONT->(!EOF())
		...
		While QRYCONT->U00_FAQUIS = cTipo
			...
			oDetalhe:Cell("U04_DTUTIL"):SetValue(StoD(QRYCONT->U04_DTUTIL))
			oDetalhe:Cell("U04_QUEMUT"):SetValue(QRYCONT->U04_QUEMUT)
	...
	oTotalGer:Init()
	oTotalGer:Cell("nQtdGeral"):SetValue("Qtd dos Contratos Utilizados: " + cValToChar(nQtdGeral))
	oTotalGer:Cell("nTotalGer"):SetValue("Total dos Contrato Utilizados: R$" + Transform(nTotal,"@E 999,999,999.99"))
...
/*03*/AADD(aP,{"Plano	        ?","C",99,0,"G",""					  	,"U05MRK","      "	,"","","","",""})
/*05*/AADD(aP,{"Data de Utilização de  ?","D",08,0,"G",""					  	,""   ,""		,"","","","",""})
/*06*/AADD(aP,{"Data de Utilização até ?","D",08,0,"G","(mv_par05>=mv_par04)"	,""   ,""		,"","","","",""})
/*07*/AADD(aP,{"Cliente de     	?","C",06,0,"G",""						,"SA1","      "	,"","","","",""})
/*08*/AADD(aP,{"Loja de       	?","C",02,0,"G",""						,""	  ,"  "	   	,"","","","",""})
/*09*/AADD(aP,{"Cliente até    	?","C",06,0,"G","(mv_par08>=mv_par06)"	,"SA1","ZZZZZZ"	,"","","","",""})
/*10*/AADD(aP,{"Loja até       	?","C",02,0,"G","(mv_par09>=mv_par07)"	,""	  ,"ZZ"	   	,"","","","",""})
...
/*03*/AADD(aHelp,{"Informe o código do plano."})
/*05*/AADD(aHelp,{"Informe a data de utilização.","inicial."})
/*06*/AADD(aHelp,{"Informe a data de utilização.","final."})
