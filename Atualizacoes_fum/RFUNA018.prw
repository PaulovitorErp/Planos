...
ฑฑบPrograma  ณ RFUNA018 บ Autor ณ Wellington Gon็alves บ Dataณ 25/08/2016 บฑฑ
...
oBrowse:SetDescription( 'Cadastro de Religi๕es' )
...
oModel:GetModel('UG3MASTER'):SetDescription('Dados da religiใo')
...
oView:AddField('VIEW_UG3' , oStruUG3, 'UG3MASTER') // cria o cabe็alho
