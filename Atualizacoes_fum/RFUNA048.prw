...
/*###########################################################################
#############################################################################
## Programa  | RFUNA048 | Autor | Wellington Gonçalves | Data | 25/05/2019 ##
##=========================================================================##
...
ADD OPTION aRotina Title 'Visualizar'  	Action 'VIEWDEF.RFUNA048' 	OPERATION 02 ACCESS 0      
ADD OPTION aRotina Title 'Imprimir'    	Action 'VIEWDEF.RFUNA048' 	OPERATION 08 ACCESS 0
...
oModel := MPFormModel():New( 'PFUNA048', /*bPreValidacao*/, /*bPosValidacao*/, /*bCommit*/, /*bCancel*/ )
...
oModel:SetRelation( 'IU69DETAIL', { { 'U69_FILIAL', 'xFilial( "U69" )' } , { 'U69_CODIGO', 'U68_CODIGO' } , { 'U69_TPALT', "'I'" } } , U69->( IndexKey( 1 ) ) )  

// Crio o Grid de exclusoes
oModel:AddGrid( 'EU69DETAIL', 'U68MASTER', oStruU69, /*bLinePre*/, /*bLinePost*/, /*bPreVal*/, /*bPosVal*/, /*BLoad*/ )    

// Faço o relaciomaneto 
oModel:SetRelation( 'EU69DETAIL', { { 'U69_FILIAL', 'xFilial( "U69" )' } , { 'U69_CODIGO', 'U68_CODIGO' } , { 'U69_TPALT', "'E'" } } , U69->( IndexKey( 1 ) ) )  

// Crio o Grid de alterações
oModel:AddGrid( 'AU69DETAIL', 'U68MASTER', oStruU69, /*bLinePre*/,/*bLinePost*/, /*bPreVal*/, /*bPosVal*/, /*BLoad*/ )    

// Faço o relaciomaneto
oModel:SetRelation( 'AU69DETAIL', { { 'U69_FILIAL', 'xFilial( "U69" )' } , { 'U69_CODIGO', 'U68_CODIGO' } , { 'U69_TPALT', "'A'" } } , U69->( IndexKey( 1 ) ) )   
...
// Faço o relaciomaneto 
oModel:SetRelation( 'IU70DETAIL', { { 'U70_FILIAL', 'xFilial( "U70" )' } , { 'U70_CODIGO', 'U68_CODIGO' } , { 'U70_TPALT', "'I'" } } , U70->( IndexKey( 1 ) ) )  

// Crio o Grid de exclusões
oModel:AddGrid( 'EU70DETAIL', 'U68MASTER', oStruU70, /*bLinePre*/, /*bLinePost*/, /*bPreVal*/, /*bPosVal*/, /*BLoad*/ )    

// Faço o relaciomaneto 
oModel:SetRelation( 'EU70DETAIL', { { 'U70_FILIAL', 'xFilial( "U70" )' } , { 'U70_CODIGO', 'U68_CODIGO' } , { 'U70_TPALT', "'E'" } } , U70->( IndexKey( 1 ) ) )  
...
oModel:SetRelation( 'AU70DETAIL', { { 'U70_FILIAL', 'xFilial( "U70" )' } , { 'U70_CODIGO', 'U68_CODIGO' } , { 'U70_TPALT', "'A'" } } , U70->( IndexKey( 1 ) ) )   
...
// Faço o relaciomaneto 
oModel:SetRelation( 'IU71DETAIL', { { 'U71_FILIAL', 'xFilial( "U71" )' } , { 'U71_CODIGO', 'U68_CODIGO' } , { 'U71_TPALT', "'I'" } } , U71->( IndexKey( 1 ) ) )  

// Crio o Grid de exclusões
oModel:AddGrid( 'EU71DETAIL', 'U68MASTER', oStruU71, /*bLinePre*/, /*bLinePost*/, /*bPreVal*/, /*bPosVal*/, /*BLoad*/ )    

// Faço o relaciomaneto
oModel:SetRelation( 'EU71DETAIL', { { 'U71_FILIAL', 'xFilial( "U71" )' } , { 'U71_CODIGO', 'U68_CODIGO' } , { 'U71_TPALT', "'E'" } } , U71->( IndexKey( 1 ) ) )  

// Crio o Grid de alterações
oModel:AddGrid( 'AU71DETAIL', 'U68MASTER', oStruU71, /*bLinePre*/,/*bLinePost*/, /*bPreVal*/, /*bPosVal*/, /*BLoad*/ )    

// Faço o relaciomaneto
oModel:SetRelation( 'AU71DETAIL', { { 'U71_FILIAL', 'xFilial( "U71" )' } , { 'U71_CODIGO', 'U68_CODIGO' } , { 'U71_TPALT', "'A'" } } , U71->( IndexKey( 1 ) ) )   
...
// Faço o relaciomaneto
oModel:SetRelation( 'IU72DETAIL', { { 'U72_FILIAL', 'xFilial( "U72" )' } , { 'U72_CODIGO', 'U68_CODIGO' } , { 'U72_TPALT', "'I'" } } , U72->( IndexKey( 1 ) ) )  

// Crio o Grid de exclusões
oModel:AddGrid( 'EU72DETAIL', 'U68MASTER', oStruU72, /*bLinePre*/, /*bLinePost*/, /*bPreVal*/, /*bPosVal*/, /*BLoad*/ )    

// Faço o relaciomaneto 
oModel:SetRelation( 'EU72DETAIL', { { 'U72_FILIAL', 'xFilial( "U72" )' } , { 'U72_CODIGO', 'U68_CODIGO' } , { 'U72_TPALT', "'E'" } } , U72->( IndexKey( 1 ) ) )  

// Crio o Grid de alterações
oModel:AddGrid( 'AU72DETAIL', 'U68MASTER', oStruU72, /*bLinePre*/, /*bLinePost*/, /*bPreVal*/, /*bPosVal*/, /*BLoad*/ )    

// Faço o relaciomaneto
oModel:SetRelation( 'AU72DETAIL', { { 'U72_FILIAL', 'xFilial( "U72" )' } , { 'U72_CODIGO', 'U68_CODIGO' } , { 'U72_TPALT', "'A'" } } , U72->( IndexKey( 1 ) ) )  
...
oModel:GetModel( 'IU70DETAIL' ):SetDescription( 'Inclusões:'  			)   
oModel:GetModel( 'AU70DETAIL' ):SetDescription( 'Alterações:'  			)
oModel:GetModel( 'EU70DETAIL' ):SetDescription( 'Exclusões:'  			) 
...
Local oModel   	:= FWLoadModel( 'RFUNA048' )
Local oView
...
if nOperation <> 3 // apenas se for alteração ou visualização
	...
	if U73->(DbSeek(xFilial("U73") + cCodigo + cAlias + cChave ))	
		...
		While U73->(!Eof()) .AND. U73->U73_FILIAL == xFilial("U73") .AND. U73->U73_CODIGO == cCodigo .AND. U73->U73_ALIAS == cAlias .AND. AllTrim(U73->U73_CHAVE) == AllTrim(cChave)  
